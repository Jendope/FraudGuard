...
import { GITHUB_REPO_URL, GITHUB_README_URL } from '@/lib/site-config'
import { 
  Shield, 
  Brain, 
  Bell, 
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <a 
                ...
                rel="noopener noreferrer"
              >
                <Button size="lg" variant="outline" className="rounded-full px-8 h-14 text-lg border-2 gap-2">
                  <Github className="w-5 h-5" />
                  View on GitHub
                </Button>
              </a>
  ...
  const features = [
    {
      ...
      description: 'Qwen (via DashScope) provides intelligent fraud analysis with explainable reasoning. GLM-5 available as an alternative.',
...
function HowItWorksSection() {
  ...
  const steps = [
    ...
    },
    {
      step: '04',
      title: 'LLM Analysis',
      description: 'Qwen (via DashScope) analyzes the query with retrieved context, producing a fraud score (0-10) with explanation. GLM-5 available as alternative.',
      icon: Brain
    }
  ]
...
function TechStackSection() {
  const technologies = [
    { name: 'Qwen (DashScope)', category: 'LLM', description: 'Configurable model via Alibaba Cloud DashScope API' },
    { name: 'GLM-5 (BigModel)', category: 'Alt LLM', description: 'Via ZhipuAI zai-sdk — free-tier alternative' },
    { name: 'GLM-OCR (BigModel)', category: 'OCR', description: 'REST API — layout parsing for uploaded images' },
    { name: 'Qwen ASR (DashScope)', category: 'Speech-to-Text', description: 'qwen3-asr-flash-2026-02-10 — configurable model' },
